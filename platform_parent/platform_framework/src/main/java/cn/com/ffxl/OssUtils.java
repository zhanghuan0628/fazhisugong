...
//        ACCESS_KEY_ID = bundle.containsKey("oss.access.id") == false? "" : bundle.getString("oss.access.id");  
//        ACCESS_KEY_SECRET = bundle.containsKey("oss.access.key") == false ? "" : bundle.getString("oss.access.key");  
        ENDPOINT= "oss-cn-shanghai.aliyuncs.com";
        ACCESS_KEY_ID = "LTAIgrOfu9fWCy9T";
        ACCESS_KEY_SECRET = "Yq08FhNRQNQk5lThu6wNSAMP8QwhLW";
    }  
