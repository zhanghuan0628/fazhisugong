...
public class SendEmail {
  ...
  public static void sendMessage(String smtpHost, String from, String fromUserPassword, String to, String subject, String messageText,
  ...
  public static void main(String[] args) {
    try {
      SendEmail.sendMessage(
          "smtp.gmail.com",
          "467958568@qq.com",//发送邮箱账号
          "",//发送邮箱密码
          "15026707230@163.com",//接收邮箱地址
          "hello word！",//发送内容
          "---------------wrwe-----------",
