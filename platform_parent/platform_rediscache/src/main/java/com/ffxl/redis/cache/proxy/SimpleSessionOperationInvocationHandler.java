package com.ffxl.redis.cache.proxy;

import com.ffxl.redis.cache.exception.NonsupportMethodException;
import com.ffxl.redis.cache.operation.DefaultSimpleSessionOperations;
...
public class SimpleSessionOperationInvocationHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        String methodString = METHOD_GET;
        String item = null;
        Object value = null;
        ...
        if (methodString.equals(METHOD_GET)){
            ...
            return val;
        }else if(methodString.equals(METHOD_SET)){
