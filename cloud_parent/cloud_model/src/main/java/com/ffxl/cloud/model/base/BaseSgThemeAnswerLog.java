...
public class BaseSgThemeAnswerLog implements Serializable {
    private String id;
    ...
    public boolean equals(Object that) {
        ...
        BaseSgThemeAnswerLog other = (BaseSgThemeAnswerLog) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getRightNum() == null ? other.getRightNum() == null : this.getRightNum().equals(other.getRightNum()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRightNum() == null) ? 0 : getRightNum().hashCode());
        return result;
    }
}